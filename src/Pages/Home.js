    ...
    return (
        <>
            <div class='w-full flex items-center justify-center py-3 shadow-sm shadow-gray-500'>
                <ul class='w-full md:w-1/2 m-auto flex flex-wrap items-center justify-</div>between'>
                    <a href='/'><li class='w-full md:w-auto bg-blue-100 px-2 rounded-xl mb-2 md:mb-0'>All</li></a>
